package com.precious.whatsappclone1.view.chats;
...
import com.precious.whatsappclone1.adapter.ChatsAdapter;
import com.precious.whatsappclone1.databinding.ActivityChatsBinding;
import com.precious.whatsappclone1.interfaces.OnReadChatCallBack;
...
import com.precious.whatsappclone1.view.dialog.DialogReviewSendImage;
import com.precious.whatsappclone1.view.profile.UserProfileActivity;
        ...
        if (receiverID!=null){
            ...
            if (userProfile != null) {
                if (userProfile.equals("")){
                    binding.imageProfile.setImageResource(R.drawable.placeholder);  // set  default image when profile user is null
                } else {
